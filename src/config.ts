export const CONFIG = {
  ...
  // PR (생산기)
  PR_PROC_BASE: 1000, PR_PROC_RATE: 2,   PR_PROC_EXP: 1,   PR_PROC_ACC: 1,
  PR_COST_BASE: 10,   PR_COST_RATE: 1.3, PR_COST_EXP: 2,   PR_COST_ACC: 0.005,

  // FA (공장)
  FA_PROC_BASE: 800,  FA_PROC_RATE: 2,   FA_PROC_EXP: 1,   FA_PROC_ACC: 1,
  FA_COST_BASE: 10,   FA_COST_RATE: 1.3, FA_COST_EXP: 2,   FA_COST_ACC: 0.005,

  // IT (아이템 가치)
  IT_PROC_BASE: 1,    IT_PROC_RATE: 1,   IT_PROC_EXP: 2,   IT_PROC_ACC: 1,
  IT_COST_BASE: 10,   IT_COST_RATE: 1.3, IT_COST_EXP: 2,   IT_COST_ACC: 0.005,

  // IC (아이템 수량)
  IC_PROC_BASE: 1,    IC_PROC_RATE: 2,   IC_PROC_EXP: 1,   IC_PROC_ACC: 1,
  IC_COST_BASE: 10,   IC_COST_RATE: 1.3, IC_COST_EXP: 2,   IC_COST_ACC: 0.005,

  // BF (버퍼)
  BF_PROC_BASE: 20,   BF_PROC_RATE: 10,  BF_PROC_EXP: 1,   BF_PROC_ACC: 1,
  BF_COST_BASE: 10,   BF_COST_RATE: 1.3, BF_COST_EXP: 2,   BF_COST_ACC: 0.005,

  // RL (레일)
  RL_PROC_BASE: 2500, RL_PROC_RATE: 1,   RL_PROC_EXP: 1,   RL_PROC_ACC: 1,
  RL_COST_BASE: 10,   RL_COST_RATE: 1.3, RL_COST_EXP: 2,   RL_COST_ACC: 0.005,
  RAIL_SPEED_MAX_MULTIPLIER: 3.0,
  RAIL_SPEED_MAX_LEVEL: 60,

  // AM (동물)
  AM_PROC_BASE: 0.1,  AM_PROC_RATE: 0.05, AM_PROC_EXP: 2,  AM_PROC_ACC: 1,
  AM_COST_BASE: 10,   AM_COST_RATE: 1.3,  AM_COST_EXP: 2,  AM_COST_ACC: 0.005,

  // BD (라인)
  BD_PROC_BASE: 1,    BD_PROC_RATE: 1,   BD_PROC_EXP: 1,   BD_PROC_ACC: 1,
  BD_COST_BASE: 2,    BD_COST_RATE: 1.3, BD_COST_EXP: 2,   BD_COST_ACC: 0.005,
}
